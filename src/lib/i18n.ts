...
const dict = {
  en: {
    ...
    list_min: "Min items",
    list_max: "Max items",
    list_fixed: "Fixed count",
    list_unlimited: "unlimited",
    list_locked: "Locked count — items cannot be added or removed",
    list_count_label: "items",
    list_min_reached: "Minimum reached",
    list_max_reached: "Maximum reached",
    unfiled: "(Unfiled)",
  ...
  th: {
    ...
    root_folder: "ราก",
    list_settings: "ตั้งค่าลิสต์",
    list_min: "จำนวนขั้นต่ำ",
    list_max: "จำนวนสูงสุด",
    list_fixed: "ล็อคจำนวน",
    list_unlimited: "ไม่จำกัด",
    list_locked: "ล็อคจำนวนไว้ — เพิ่มหรือลบสมาชิกไม่ได้",
    list_count_label: "รายการ",
    list_min_reached: "ถึงจำนวนขั้นต่ำแล้ว",
    list_max_reached: "ถึงจำนวนสูงสุดแล้ว",
